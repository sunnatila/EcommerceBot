...
@dp.message(StateFilter("get_admin_username"))
...
@dp.message(lambda msg: msg.text == "👤 Adminlar ro'yxati")
...
@dp.callback_query(StateFilter("get_admin_id"), lambda call: call.data == "back")
...
@dp.callback_query(StateFilter("get_admin_info"))
